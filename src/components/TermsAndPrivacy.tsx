...
export const TermsAndPrivacy: React.FC<TermsAndPrivacyProps> = ({
  ...
  React.useEffect(() => {
    if (isOpen && type) {
      setActiveTab(type === "PRIVACY" ? "privacy" : "terms");
    }
  }, [type, isOpen]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md" id="terms_privacy_overlay">
      <div className="bg-[#0A2540] border-2 border-white/15 rounded-3xl w-full max-w-2xl h-[85vh] flex flex-col shadow-2xl overflow-hidden relative text-left transition-all duration-300">
        
        {/* UPPER TITLE BAR */}
        <div className="p-5 border-b border-white/10 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="p-2.5 bg-slate-900 border border-[#7EF9FF]/30 rounded-xl text-cyan-400">
              {activeTab === "privacy" ? <FileText className="w-5 h-5 animate-pulse" /> : <Scale className="w-5 h-5 animate-pulse" />}
            </div>
            <div>
          ...
          <button
            onClick={onClose}
            className="p-2 bg-white/5 hover:bg-white/15 text-gray-400 hover:text-white rounded-xl transition-all duration-200 cursor-pointer hover:scale-105 active:scale-95"
            title="Cerrar"
          >
            <X className="w-4 h-4" />
          </button>
        ...
        {/* TABS SELECTORBAR */}
        <div className="flex bg-[#07111F]/50 border-b border-white/10 p-1.5 px-3 gap-2">
          <button
            onClick={() => setActiveTab("privacy")}
            className={`px-4 py-2 text-xs font-mono rounded-lg transition-all duration-200 cursor-pointer ${
              activeTab === "privacy" 
                ? "bg-[#113A63] border border-[#7EF9FF]/30 text-[#7EF9FF] font-black shadow-inner shadow-cyan-400/10 scale-[1.02]" 
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6 text-sm text-gray-200 font-sans leading-relaxed">
          
          {/* HIGH-CONTRAST LEGAL DISCLAIMER BANNER */}
          <div className="p-4 rounded-2xl bg-amber-500/10 border-2 border-amber-500/25 flex items-start space-x-3 shadow-inner shadow-amber-500/5">
          ...
          {activeTab === "privacy" ? (
            <div className="space-y-4">
              <h4 className="font-display font-semibold text-white text-base border-b border-white/5 pb-1">1. Tratamiento y Resguardo de Datos Personales</h4>
              <p>
              ...
              <h4 className="font-display font-semibold text-white text-base border-b border-white/5 pb-1">2. Seguridad de tus Respuestas</h4>
              <p>
              ...
              <h4 className="font-display font-semibold text-white text-base border-b border-white/5 pb-1">3. Derechos de Acceso y Eliminación</h4>
              <p>
            ...
            <div className="space-y-4">
              <h4 className="font-display font-semibold text-white text-base border-b border-white/5 pb-1">1. Objeto y Alcance del Programa</h4>
              <p>
              ...
              <h4 className="font-display font-semibold text-white text-base border-b border-white/5 pb-1">2. Ausencia de Relación Profesional / Clínica</h4>
              <p>
              ...
              <h4 className="font-display font-semibold text-white text-base border-b border-white/5 pb-1">3. Exclusión Total de Responsabilidad</h4>
              <p>
              ...
              <h4 className="font-display font-semibold text-white text-base border-b border-white/5 pb-1">4. Propiedad Intelectual</h4>
              <p>
        ...
        {/* MODAL FOOTER BAR */}
        <div className="p-4 bg-[#07111F]/50 border-t border-white/10 text-center">
          <button
            onClick={onClose}
            className="px-6 py-2.5 bg-[#7EF9FF] hover:bg-[#00D4FF] text-slate-900 font-mono font-bold text-xs rounded-xl tracking-wider transition-all duration-200 cursor-pointer hover:scale-105 active:scale-95 shadow-md shadow-cyan-400/20"
          >
